...
Call is issued (see below) then the Last-Call should reflect the IESG's view.
...
IESG recommendation. In addition, in case of significant controversy
...
Split IESG work pre- and post- IETF LC.
